...
const ExperienceContainer = () => {
  return (
    <div className='py-20 relative isolate' id='experience'>
      <div className='mt-12 grid sm:grid-cols-2 gap-24 mb-8'>
        <div className='flex flex-col'>
          ...
          <p className='mt-2 text-lg text-gray-500 dark:text-gray-200 mb-6'>
            A lo largo de mis años como Diseñador UI y Frontend, he tenido la
            oportunidad de participar en proyectos de diversas áreas, incluyendo
            telecomunicaciones, seguros, banca y salud, entre otros.
          </p>
          <p className='mt-2 text-lg text-gray-500 dark:text-gray-200 mb-6'>
